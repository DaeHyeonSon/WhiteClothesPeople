...
//    							HttpSession session) {
	public String updateProfile(@ModelAttribute UserProfileUpdateDTO userProfileUpdateDTO , HttpSession session) throws Exception {
...
//		}
		...
		// 프로필 정보 업데이트
		UserProfileDTO userProfileDTO =  profileService.saveProfile(sessionDTO , userProfileUpdateDTO);
