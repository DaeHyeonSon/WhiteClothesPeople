...
.form-group p, .form-group input[type="text"], .form-group select,
	.form-group textarea {
	width: 100%;
	padding: 10px;
	border-radius: 5px;
...
.form-group p {
	...
	border: 1px solid #ccc;
	border-radius: 5px;
	background-color: transparent; /* í¬ëªíê² ì¤ì  */
		...
		<form action="${pageContext.request.contextPath}/updateProfile"
			...
			<div class="profile-image-container">
				<img src="https://via.placeholder.com/120" alt="Profile Picture"
					id="profile-picture"> <label for="profileImage">프로필
					이미지</label> <input type="file" id="profileImage" name="profileImage"
					accept="image/*">
			</div>
			<!-- Name Section -->
			...
			<!-- Hobbies Section -->
			<div class="form-group">
				<label for="hobbies">취미</label> <input type="text" id="hobbies"
					name="hobbies" placeholder="취미">
			</div>
			<!-- Address Section -->
			<div class="form-group">
			...
			<!-- Income Section -->
			<div class="form-group">
				<label for="income">수입(연봉)</label> <select id="income" name="income">
					<option value="2000-3000">2000만원 ~ 3000만원</option>
					<option value="3000-4000">3000만원 ~ 4000만원</option>
					<option value="4000-5000">4000만원 ~ 5000만원</option>
					<option value="5000-6000">5000만원 ~ 6000만원</option>
					<option value="6000-7000">6000만원 ~ 7000만원</option>
					<option value="7000-8000">7000만원 ~ 8000만원</option>
					<option value="8000-9000">8000만원 ~ 9000만원</option>
					<option value="9000-10000">9000만원 ~ 1억원</option>
